## [4.39.0](https://github.com/algolia/algoliasearch-client-go/compare/4.38.0...4.39.0)
...
## [4.38.0](https://github.com/algolia/algoliasearch-client-go/compare/4.37.3...4.38.0)
...
- [62b19a4dc](https://github.com/algolia/api-clients-automation/commit/62b19a4dc) fix(deps): httpsnippet migration ([#5992](https://github.com/algolia/api-clients-automation/pull/5992)) by [@Fluf22](https://github.com/Fluf22/)

## [4.36.1](https://github.com/algolia/algoliasearch-client-go/compare/4.36.0...4.36.1)
...
## [4.35.0](https://github.com/algolia/algoliasearch-client-go/compare/4.34.2...4.35.0)
...
- [d4a26ec40](https://github.com/algolia/api-clients-automation/commit/d4a26ec40) feat(go): enhance API request handling with body parameters support ([#5826](https://github.com/algolia/api-clients-automation/pull/5826)) by [@Fluf22](https://github.com/Fluf22/)

## [4.34.2](https://github.com/algolia/algoliasearch-client-go/compare/4.34.1...4.34.2)
...
## [4.34.1](https://github.com/algolia/algoliasearch-client-go/compare/4.34.0...4.34.1)
...
## [4.34.0](https://github.com/algolia/algoliasearch-client-go/compare/4.33.0...4.34.0)
...
## [4.33.0](https://github.com/algolia/algoliasearch-client-go/compare/4.32.0...4.33.0)
...
## [4.32.0](https://github.com/algolia/algoliasearch-client-go/compare/4.31.0...4.32.0)
...
## [4.29.0](https://github.com/algolia/algoliasearch-client-go/compare/4.28.2...4.29.0)
...
## [4.27.0](https://github.com/algolia/algoliasearch-client-go/compare/4.26.0...4.27.0)
...
## [4.26.0](https://github.com/algolia/algoliasearch-client-go/compare/4.25.0...4.26.0)
...
## [4.25.0](https://github.com/algolia/algoliasearch-client-go/compare/4.24.0...4.25.0)
...
## [4.24.0](https://github.com/algolia/algoliasearch-client-go/compare/4.23.0...4.24.0)
...
- [a1e517c688](https://github.com/algolia/api-clients-automation/commit/a1e517c688) feat(go): add bridge to transformation on search ([#4924](https://github.com/algolia/api-clients-automation/pull/4924)) by [@shortcuts](https://github.com/shortcuts/)
...
## [4.12.1](https://github.com/algolia/algoliasearch-client-go/compare/4.12.0...4.12.1)
...
## [4.12.0](https://github.com/algolia/algoliasearch-client-go/compare/4.11.0...4.12.0)
...
## [4.11.0](https://github.com/algolia/algoliasearch-client-go/compare/4.10.2...4.11.0)
...
## [4.10.2](https://github.com/algolia/algoliasearch-client-go/compare/4.10.1...4.10.2)
...
## [4.10.1](https://github.com/algolia/algoliasearch-client-go/compare/4.10.0...4.10.1)
...
## [4.5.4](https://github.com/algolia/algoliasearch-client-go/compare/4.5.3...4.5.4)
...
## [4.2.4](https://github.com/algolia/algoliasearch-client-go/compare/4.2.3...4.2.4)
...
## [4.2.1](https://github.com/algolia/algoliasearch-client-go/compare/4.2.0...4.2.1)
...
## [4.2.0](https://github.com/algolia/algoliasearch-client-go/compare/4.1.1...4.2.0)
...
## [4.1.1](https://github.com/algolia/algoliasearch-client-go/compare/4.1.0...4.1.1)
...
## [4.0.1](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0...4.0.1)
...
## [4.0.0](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.30...4.0.0)

New major version released! Browse [our documentation](https://www.algolia.com/doc/libraries/go)
...
## [4.0.0-beta.30](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.29...4.0.0-beta.30)
...
## [4.0.0-beta.29](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.28...4.0.0-beta.29)
...
## [4.0.0-beta.28](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.27...4.0.0-beta.28)
...
## [4.0.0-beta.27](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.26...4.0.0-beta.27)
...
## [4.0.0-beta.26](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.25...4.0.0-beta.26)
...
- [39eb92beb](https://github.com/algolia/api-clients-automation/commit/39eb92beb) chore(go): update enum casing ([#3163](https://github.com/algolia/api-clients-automation/pull/3163)) by [@Fluf22](https://github.com/Fluf22/)
...
## [4.0.0-beta.15](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.14...4.0.0-beta.15)
...
- [34a1694c3](https://github.com/algolia/api-clients-automation/commit/34a1694c3) fix(go): upgrade the linter ([#3140](https://github.com/algolia/api-clients-automation/pull/3140)) by [@millotp](https://github.com/millotp/)
...
## [4.0.0-beta.14](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.13...4.0.0-beta.14)
...
## [4.0.0-beta.13](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.12...4.0.0-beta.13)
...
## [4.0.0-beta.12](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.11...4.0.0-beta.12)
...
## [4.0.0-beta.11](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.10...4.0.0-beta.11)
...
## [4.0.0-beta.8](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.7...4.0.0-beta.8)
...
## [4.0.0-beta.7](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.6...4.0.0-beta.7)
...
- [7a2d36901](https://github.com/algolia/api-clients-automation/commit/7a2d36901) feat(go): add generateSecuredApiKey helper ([#2797](https://github.com/algolia/api-clients-automation/pull/2797)) by [@millotp](https://github.com/millotp/)
...
## [4.0.0-beta.3](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.2...4.0.0-beta.3)
...
## [4.0.0-beta.2](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-beta.1...4.0.0-beta.2)
...
## [4.0.0-alpha.44](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-alpha.43...4.0.0-alpha.44)
...
## [4.0.0-alpha.41](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-alpha.40...4.0.0-alpha.41)
...
## [4.0.0-alpha.40](https://github.com/algolia/algoliasearch-client-go/compare/4.0.0-alpha.39...4.0.0-alpha.40)
