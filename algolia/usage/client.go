...
// APIClient manages communication with the Usage API API v1.0.0
...
func NewClient(appID, apiKey string) (*APIClient, error) {
	return NewClientWithConfig(UsageConfiguration{
...
func NewClientWithConfig(cfg UsageConfiguration) (*APIClient, error) {
	if cfg.AppID == "" {
...
func getDefaultHosts() []transport.StatefulHost {
	return []transport.StatefulHost{
		...
		transport.NewStatefulHost("https", "usage-dev.algolia.com", call.IsReadWrite),
	}
}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.2.3); Go (%s); Usage (4.2.3)", runtime.Version())
}
