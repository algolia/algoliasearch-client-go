...
/*
GetIndexUsage calls the API and returns the raw response from it.
	...
	Request can be constructed by NewApiGetIndexUsageRequest with parameters below.
	  ...
	  @param startDate string - Start date of the period to analyze, in RFC 3339 format.
	  @param endDate string - End date of the period to analyze, in RFC 3339 format.
	...
	@return error - An error if the API call fails
*/
func (c *APIClient) GetIndexUsageWithHTTPInfo(r ApiGetIndexUsageRequest, opts ...RequestOption) (*http.Response, []byte, error) {
	...
	if r.startDate == "" {
		return nil, nil, reportError("Parameter `startDate` is required when calling `GetIndexUsage`.")
	}
	if r.endDate == "" {
	...
	if !utils.IsNilOrEmpty(r.granularity) {
		conf.queryParams.Set("granularity", utils.QueryParameterToString(r.granularity))
	}
...
/*
GetIndexUsage casts the HTTP response body to a defined struct.
...
/*
GetUsage calls the API and returns the raw response from it.
	...
	@return error - An error if the API call fails
*/
func (c *APIClient) GetUsageWithHTTPInfo(r ApiGetUsageRequest, opts ...RequestOption) (*http.Response, []byte, error) {
...
/*
GetUsage casts the HTTP response body to a defined struct.
