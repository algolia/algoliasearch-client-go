...
// APIClient manages communication with the Query Suggestions API API v1.0.0
...
func NewClientWithConfig(cfg Configuration) *APIClient {
	...
	if cfg.Host == "" {
		...
		cfg.Host = getDefaultHost(cfg.Region)
	}
...
func getDefaultHost(region Region) string {
	return strings.Replace("https://query-suggestions.us.algolia.com", "{region}", string(region), -1)

}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.1); Go (%s); Query-suggestions (4.0.0-alpha.1)", runtime.Version())
}
