...
func getDefaultHosts(r Region) []transport.StatefulHost {
	return []transport.StatefulHost{transport.NewStatefulHost("https", strings.ReplaceAll("query-suggestions.{region}.algolia.com", "{region}", string(r)), call.IsReadWrite)}
}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.44); Go (%s); QuerySuggestions (4.0.0-alpha.44)", runtime.Version())
}
