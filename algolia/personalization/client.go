...
func getDefaultHosts(r Region) []transport.StatefulHost {
	return []transport.StatefulHost{
		transport.NewStatefulHost("https", strings.ReplaceAll("personalization.{region}.algolia.com", "{region}", string(r)), call.IsReadWrite),
	}
}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.28.2); Go (%s); Personalization (4.28.2)", runtime.Version())
}
