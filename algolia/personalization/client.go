...
func getDefaultHosts(r Region) []*transport.StatefulHost {
	return []*transport.StatefulHost{transport.NewStatefulHost(strings.ReplaceAll("personalization.{region}.algolia.com", "{region}", string(r)), call.IsReadWrite)}
}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.42); Go (%s); Personalization (4.0.0-alpha.42)", runtime.Version())
}
