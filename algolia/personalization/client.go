...
func getDefaultHost(region Region) string {
	return strings.Replace("https://personalization.us.algolia.com", "{region}", string(region), -1)

}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.1); Go (%s); Personalization (4.0.0-alpha.1)", runtime.Version())
}
