...
func getDefaultHosts(r Region) []*transport.StatefulHost {
	...
	switch r {
	case EU, US:
		hosts = append(hosts, transport.NewStatefulHost(strings.ReplaceAll("personalization.{region}.algolia.com", "{region}", string(r)), call.IsReadWrite))
	}
	return hosts
}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.37); Go (%s); Personalization (4.0.0-alpha.37)", runtime.Version())
}
