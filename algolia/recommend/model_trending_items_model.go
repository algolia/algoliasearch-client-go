...
// Values returns the list of allowed values of TrendingItemsModel.
func (v TrendingItemsModel) Values() []TrendingItemsModel {
	return AllowedTrendingItemsModelEnumValues
}
