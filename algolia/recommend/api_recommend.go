...
func (c *APIClient) GetRecommendations(getRecommendationsParams *GetRecommendationsParams) (*GetRecommendationsResponse, error) {
	var (
		localVarPostBody any
		body             any
