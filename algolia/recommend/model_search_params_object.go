...
func WithSearchParamsObjectAroundPrecision(val int32) SearchParamsObjectOption {
	return func(f *SearchParamsObject) {
...
func (o *SearchParamsObject) GetAroundPrecision() int32 {
...
// and a boolean to check if the value has been set.
func (o *SearchParamsObject) GetAroundPrecisionOk() (*int32, bool) {
	if o == nil || o.AroundPrecision == nil {
		return nil, false
	}
...
func (o *SearchParamsObject) SetAroundPrecision(v int32) {
	o.AroundPrecision = &v
}
