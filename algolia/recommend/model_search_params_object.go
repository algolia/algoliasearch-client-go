...
func WithSearchParamsObjectNaturalLanguages(val []SupportedLanguage) SearchParamsObjectOption {
	return func(f *SearchParamsObject) {
...
func (o *SearchParamsObject) GetNaturalLanguages() []SupportedLanguage {
...
// and a boolean to check if the value has been set.
func (o *SearchParamsObject) GetNaturalLanguagesOk() ([]SupportedLanguage, bool) {
	if o == nil || o.NaturalLanguages == nil {
		return nil, false
	}
...
func (o *SearchParamsObject) SetNaturalLanguages(v []SupportedLanguage) *SearchParamsObject {
