...
func (o *RankingOption) Equal(o2 *RankingOption) bool {
	if o == nil {
		return o2 == nil || reflect.DeepEqual(o2.value, []string{"typo", "geo", "words", "filters", "proximity", "attribute", "exact", "custom"})
	}
	if o2 == nil {
		return o == nil || reflect.DeepEqual(o.value, []string{"typo", "geo", "words", "filters", "proximity", "attribute", "exact", "custom"})
	}
