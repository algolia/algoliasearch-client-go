...
// CamelCaseAttributesOption is a wrapper for an CamelCaseAttributes option parameter. It holds
...
// CamelCaseAttributesEqual returns true if the two options are equal.
