...
// ReplaceSynonymsInHighlightOption is a wrapper for an ReplaceSynonymsInHighlight option parameter. It holds
...
// ReplaceSynonymsInHighlightOption.
...
// ReplaceSynonymsInHighlightEqual returns true if the two options are equal.
