...
// ClickAnalyticsOption is a wrapper for an ClickAnalytics option parameter. It holds
...
// ClickAnalyticsEqual returns true if the two options are equal.
