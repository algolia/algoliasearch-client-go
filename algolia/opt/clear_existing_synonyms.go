...
// ClearExistingSynonymsOption is a wrapper for an ClearExistingSynonyms option parameter. It holds
...
func ClearExistingSynonyms(v bool) *ClearExistingSynonymsOption {
	return &ClearExistingSynonymsOption{v}
}

// Get retrieves the actual value of the option parameter.
func (o *ClearExistingSynonymsOption) Get() bool {
	if o == nil {
		return false
	}
	return o.value
...
// value of the option.
func (o *ClearExistingSynonymsOption) Equal(o2 *ClearExistingSynonymsOption) bool {
	if o == nil {
...
// ClearExistingSynonymsEqual returns true if the two options are equal.
