...
// NaturalLanguagesOption is a wrapper for an NaturalLanguages option parameter. It holds
...
// value of the option.
func (o *NaturalLanguagesOption) Equal(o2 *NaturalLanguagesOption) bool {
	if o == nil {
...
// NaturalLanguagesEqual returns true if the two options are equal.
