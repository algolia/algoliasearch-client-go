...
// APIClient manages communication with the A/B Testing API API v1.0.0
...
func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.42); Go (%s); Abtesting (4.0.0-alpha.42)", runtime.Version())
}
