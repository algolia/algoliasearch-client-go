...
func getDefaultHost(region Region) string {
	return strings.Replace("https://analytics.us.algolia.com", "{region}", string(region), -1)

}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.1); Go (%s); Analytics (4.0.0-alpha.1)", runtime.Version())
}
