...
func getDefaultHosts(r Region) []*transport.StatefulHost {
	...
	switch r {
	case DE, US:
		hosts = append(hosts, transport.NewStatefulHost(strings.Replace("analytics.{region}.algolia.com", "{region}", string(r), -1), call.IsReadWrite))
	default:
...
func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.34); Go (%s); Analytics (4.0.0-alpha.34)", runtime.Version())
}
