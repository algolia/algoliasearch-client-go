...
func getDefaultHost(region Region) string {
	return strings.Replace("https://insights.us.algolia.io", "{region}", string(region), -1)

}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.2); Go (%s); Insights (4.0.0-alpha.2)", runtime.Version())
}
