...
func getDefaultHosts(r Region) []*transport.StatefulHost {
	...
	switch r {
	case DE, US:
		hosts = append(hosts, transport.NewStatefulHost(strings.Replace("insights.{region}.algolia.io", "{region}", string(r), -1), call.IsReadWrite))
	default:
...
func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.34); Go (%s); Insights (4.0.0-alpha.34)", runtime.Version())
}
