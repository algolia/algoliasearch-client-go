...
func getDefaultHosts(r Region) []transport.StatefulHost {
	...
	return []transport.StatefulHost{
		transport.NewStatefulHost("https", strings.ReplaceAll("insights.{region}.algolia.io", "{region}", string(r)), call.IsReadWrite),
	}
}

func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.34.2); Go (%s); Insights (4.34.2)", runtime.Version())
}
