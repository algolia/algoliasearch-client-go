...
// Client provides methods to interact with the Algolia Dictionaries API.
type Client struct {
	appID        string
...
// NewClient instantiates a new client able to interact with the Algolia Dictionaries API.
