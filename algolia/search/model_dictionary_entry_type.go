...
// Values returns the list of allowed values of DictionaryEntryType.
func (v DictionaryEntryType) Values() []DictionaryEntryType {
	return AllowedDictionaryEntryTypeEnumValues
}
