...
func WithBaseSearchParamsAroundPrecision(val int32) BaseSearchParamsOption {
	return func(f *BaseSearchParams) {
...
func (o *BaseSearchParams) GetAroundPrecision() int32 {
...
// and a boolean to check if the value has been set.
func (o *BaseSearchParams) GetAroundPrecisionOk() (*int32, bool) {
	if o == nil || o.AroundPrecision == nil {
		return nil, false
	}
...
func (o *BaseSearchParams) SetAroundPrecision(v int32) {
	o.AroundPrecision = &v
}
