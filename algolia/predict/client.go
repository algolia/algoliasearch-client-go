...
// APIClient manages communication with the Predict API API v1.0.0
...
func getDefaultHosts(r Region) []*transport.StatefulHost {
	...
	switch r {
	case EU, US:
		hosts = append(hosts, transport.NewStatefulHost(strings.Replace("predict.{region}.algolia.com", "{region}", string(r), -1), call.IsReadWrite))
	}
	return hosts
}
func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.0.0-alpha.10); Go (%s); Predict (4.0.0-alpha.10)", runtime.Version())
}
