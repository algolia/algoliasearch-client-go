...
func NewClientWithConfig(cfg AgentStudioConfiguration) (*APIClient, error) {
	if cfg.AppID == "" {
...
func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.41.0); Go (%s); AgentStudio (4.41.0)", runtime.Version())
}
...
func (c *APIClient) GetConfiguration() *AgentStudioConfiguration {
	return c.cfg
}
