...
func NewClient(appID, apiKey string, region Region) (*APIClient, error) {
	return NewClientWithConfig(AbtestingV3Configuration{
...
func NewClientWithConfig(cfg AbtestingV3Configuration) (*APIClient, error) {
	if cfg.AppID == "" {
...
func getUserAgent() string {
	return fmt.Sprintf("Algolia for Go (4.32.0); Go (%s); AbtestingV3 (4.32.0)", runtime.Version())
}
...
func (c *APIClient) GetConfiguration() *AbtestingV3Configuration {
	return c.cfg
}
